...
{
emp.action="ItemsInfo2.jsp";
emp.submit();
}else
{
emp.action="ItemsCatInfo1.jsp";
emp.submit();
...
document.emp.action="ItemsCatInfo.jsp";
document.emp.submit();
}
...
<%
 Connection con=null;
 ResultSet rs=null;
 String itcat=request.getParameter("cat");
 ...
 try 
 {
	 ...
	 rs = stmt.executeQuery("select * from items_info where itcat='"+ itcat + "' order by item_id");
 ...
 catch(Exception e) 
 {
  ...
  <%
    ...
    <option>THERMAL POWER PLANT</option>
		 ...
		 </select><input type=button value="Get Data" onclick="return Go1()"></TD>
