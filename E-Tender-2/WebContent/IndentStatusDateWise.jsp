...
<%
 ...
 try 
 {
	...
	String  empid=session.getValue("empid")+"";
	 ...
	 rs = stmt.executeQuery("select inm.ind_no,to_char(inm.inddate,'dd-mon-yyyy'),to_char(inm.delv_date,'dd-mon-yyyy'),inm.est_rate,inm.status from indent_master inm where inm.inddate between '" + dt + "' and '" + dt1 + "' and inm.emp_id='" + empid + "'  order by inm.ind_no");
