...
function selectedCourseExam()
	...
	if (courseIdValue==null ||courseIdValue=="" || courseIdValue=="0") {
		...
		<div id="body">
			<html:form action="/examAction">
				...
				<div class="body-content">
					...
					<div class="courseHeader">Exam Page</div>
					<div class="personaltable">
						<table>
							<%-- <logic:notEmpty name="examForm" property="examAddedMessage">
								<tr>
									<td><bean:write name="examForm"
											property="examAddedMessage" /></td>
								</tr>
								<tr>
							</logic:notEmpty> --%>
							...
							<tr>
								...
								<td><html:select property="courseId" styleId="courseId">
										...
										<html:optionsCollection name="examForm"
							...
							<tr>
								...
								<td><html:button property="addBtn" styleClass="loginBtn"
										value="Submit" onclick="return selectedCourseExam();" /></td>
							</tr>
						</table>
					</div>
				</div>
