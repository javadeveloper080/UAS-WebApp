...
{
  alert(pid);
  window.open("UpdateEmp.jsp?pid="+ pid + " ","popup","width=500,height=500")
}
...
<body>
	...
	<TABLE width=100%>
		<TR>
			<TD class=tabdata width=25%><a href="EmployeeInfo.jsp"><font
					color="#FFFFFF">EMPLOYEE INFORMATION</font></a></TD>
			<TD class=tabdata width=25%><a href="SupplierInfo.jsp"><font
					color="#FFFFFF">SUPPLIER INFORMATION</font></a></TD>
			<TD class=tabdata width=25%><a href="ItemsInfo.jsp"><font
					color="#FFFFFF">ITEMS INFORMATION</font></a></TD>
			<TD class=tabdata width=25%><a href="Home.jsp"><font
					color="#FFFFFF">LOG OUT</font></a></TD>
		<TR>
	</TABLE>
...
document.emp.action="EmployeeInfo.jsp";
document.emp.submit();
}
...
%>
 ...
 try 
 {
	...
	rs = stmt.executeQuery("select emp_id,pwd,name,gen,phno,address,qlfy,doj,desg,dept from employee_info order by emp_id");
  ...
  %>
	...
	<FORM NAME="emp" METHOD="POST">
		...
		<input type=hidden name=pageNo value="<%=pageNo%>"> <input
			type=hidden name="test"> <input type=hidden name=mode>
		<center>
			<h1 class=tabhead>EMPLOYEE INFORMATION</h1>
		</center>
		<table align=center border=1 colspace=10>
			<th class=tabhead3>Emp Id
			<th class=tabhead3>Name
			
			<th class=tabhead3>Gender
			<th class=tabhead3>Phone No
			<th class=tabhead3>Address
			<th class=tabhead3>Qualification
			<th class=tabhead3>Doj
			<th class=tabhead3>Desg
			<th class=tabhead3>Dept
	    ...
	    %>
			<tr>
				...
				<td class=tabhead1><%=rs.getString(8) %></td>
				<td class=tabhead1><%=rs.getString(9) %></td>
				<td class=tabhead1><%=rs.getString(10) %></td>
		...
		<TABLE WIDTH="985">
			<TR>
				...
				<TD ALIGN=CENTER><INPUT TYPE=BUTTON value="NEW" onclick="Go()";>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <INPUT TYPE=BUTTON
					value="First" onclick="check('first')";>&nbsp;&nbsp;&nbsp;&nbsp;
					<INPUT TYPE=BUTTON value="Previous" onclick="check('previous')";>&nbsp;&nbsp;&nbsp;&nbsp;
					<INPUT TYPE=BUTTON value="Next" onclick="check('next')";>&nbsp;&nbsp;&nbsp;&nbsp;
					<INPUT TYPE=BUTTON value="Last" onclick="check('last')";></TD>
			</TR>
		</TABLE>
