            ...
            <div class="row mt">
                <div class="col-lg-12">
                    <div class="form-panel">
                        <h5><Strong>Add/Edit Letter Template</Strong> </h5>
                        
                       <h5><p ><em><strong style="color:red"><bean:write name="letterTemplateForm" property="message" /></strong></em></p></h5>
                        
                        <html:form  styleClass="" action="/letterTemplateAction" method="post" enctype="multipart/form-data" >
                            ...
                            <html:hidden name="letterTemplateForm" property="pageName" styleId="pageName" />
                            <div align="center">
                ...
                <div class="col-md-12">
                    <div class="content-panel">
                        <table class="table table-striped table-advance table-hover">
                            ...
                            <tbody>
                                <logic:notEmpty name="letterTemplateForm" property="letterTemplateList">
                                    <logic:iterate id="typeTable" name="letterTemplateForm" property="letterTemplateList" type="org.edu.uams.server.pojo.LetterTemplateEntity">
                                        <tr>
...
<script>
    ...
    function getEditTypeForm(id) {
        ...
        document.typeTableForm.action="letterTemplateAction.do?method=letterTemplatePage";
