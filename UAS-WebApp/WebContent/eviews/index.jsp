...
<html lang="en">
    <head>
        ...
        <title>University Admission & Maintenance System </title>
                ...
                <section class="wrapper base-min-height">
                    ...
                    <div class="row mt">
                        <div class="col-lg-12">
                            ...
                            <h3>Our Motto:</h3> 
                            <p align="justify">To give a learning platform that is safe and secure environment that is reliable, available online and accessible to a wide user base.
                            </p>
                        </div>
                    </div>
