...
public class ApplicationIntializer {
	...
	private static void createUserMasterTypeValues() {
		...
		if (userTypelist==null || userTypelist.isEmpty()) {
			UserMasterTypeEntity professor = new UserMasterTypeEntity(ApplicationConstants.PROFESSOR);
			UserMasterTypeEntity student = new UserMasterTypeEntity(ApplicationConstants.STUDENT);
	...
	private static void createUserMasterDefaultValue() {
		...
		UserMasterEntity student =userMasterDao.findUserName("student@email.com");
		UserMasterEntity professor =userMasterDao.findUserName("professor@email.com");


		if (student==null) {
			student=new UserMasterEntity();
			student.setEmail("student@email.com");
			student.setGender("Male");
			student.setAddressLine1("Mg road");
			student.setAddressLine2("Chruch Street ");
			student.setFirstName(ApplicationConstants.STUDENT);
			student.setLastName(ApplicationConstants.ADMIN);
			student.setPassWord("pwd");
			student.setCity("Bangalore");
			student.setState("Karnataka");
			student.setCountry("India");
			student.setMobile(989898898l);
			student.setPin(560001);
			student.setUserMasterType(userMasterTypeDao.findByValue(ApplicationConstants.STUDENT));
			userMasterDao.persist(student);
		}

		if (professor==null) {
			professor=new UserMasterEntity();
			professor.setEmail("professor@email.com");
			professor.setGender("Male");
			professor.setAddressLine1("Mg road");
			professor.setAddressLine2("Chruch Street ");
			professor.setFirstName(ApplicationConstants.PROFESSOR);
			professor.setLastName(ApplicationConstants.ADMIN);
			professor.setPassWord("pwd");
			professor.setCity("Bangalore");
			professor.setState("Karnataka");
			professor.setCountry("India");
			professor.setMobile(989898898l);
			professor.setPin(560001);
			professor.setUserMasterType(userMasterTypeDao.findByValue(ApplicationConstants.PROFESSOR));
			userMasterDao.persist(professor);
		}

	}

	private static void createAdminDefaultValue() {

		AdminDao adminDao=new AdminDao();
		AdminEntity adminEntity =adminDao.findAdminName(ApplicationConstants.ADMIN);


		if (adminEntity==null) {
			adminEntity=new AdminEntity();
			adminEntity.setAdminName(ApplicationConstants.ADMIN);
			adminEntity.setEmail("admin@email.com");
			adminEntity.setPassWord("pwd");
			adminEntity.setSuperAdmin(true);
			adminDao.persist(adminEntity);
		}
